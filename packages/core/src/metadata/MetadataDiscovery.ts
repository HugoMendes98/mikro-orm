...
export class MetadataDiscovery {
  ...
  private getPrefix(prop: EntityProperty, parent: EntityProperty | null): string {
    const { embeddedPath = [], fieldNames, prefix = true, prefixBehavior } = prop;
    ...
    const behavior = prefixBehavior ?? this.config.getAll().embeddable.prefixBehavior;
    return behavior === 'absolute' ? prefix : prefixParent + prefix;
  }
